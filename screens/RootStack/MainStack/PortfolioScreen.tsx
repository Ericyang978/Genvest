...
export let PortfolioScreen = ({ navigation }: Props) => {
  ...
  webSocket.onopen = (event) => {
    webSocket.send(
      JSON.stringify({
        action: "auth",
        key: "CKCGWH2VZ2AKT1BYT9PT",
        secret: "wGshjHSdrm8GN9b3BXKGGgofgAFcDMf5dpkOdxzg",
      })
    );
  ...
  useEffect(() => {
    ...
    userStocks.forEach(async (ticker) => {
      ...
      temp[ticker] =
        response.data["bars"][response.data["bars"].length - 1]["c"];
      setStockPrices({ ...temp });
    });
  }, []);
  ...
  const topMovers: Array<CompanyStock> = [
    {
      stockName: "Apple Inc",
      stockSymbol: "AAPL",
      imageURL:
    ...
    },
    {
      ...
      stockSymbol: "META",
      imageURL:
        "https://1000logos.net/wp-content/uploads/2016/11/meta-logo.png",
      stockPrice: 1232,
      increase: true,
      percentage: 11,
    },
  ...
  const myStocks = [
    ...
    },
    {
      ...
      stockSymbol: "AMZN",
      imageURL: "https://pngimg.com/uploads/amazon/amazon_PNG13.png",
      stockPrice: 1232,
      increase: false,
      percentage: 11,
    },
    {
      stockName: "Boeing Inc",
      stockSymbol: "BA",
      imageURL:
        "https://impactnw.org/wp-content/uploads/2019/12/6130-300x300.png",
      stockPrice: 1232,
      increase: true,
      percentage: 11,
    },
    ...
    {
      stockName: "Rivian Inc",
      stockSymbol: "RIVN",
      imageURL:
        "https://upload.wikimedia.org/wikipedia/commons/e/ee/Rivian_Logo_Mark_Gold.png",
      stockPrice: 1232,
      increase: true,
      percentage: 11,
    },
    {
      stockName: "Spotify Inc",
      stockSymbol: "SPOT",
      imageURL:
    ...
    <>
      ...
      <ScrollView>
        <View style={{ padding: 20 }}>
          <Text style={{ fontWeight: "bold", fontSize: 18 }}>Top Movers</Text>
        </View>
        <View>
          {topMovers.map((props) => (
            <TouchableOpacity
        ...
        <View style={{ padding: 20 }}>
          <Text style={{ fontWeight: "bold", fontSize: 18 }}>My Stocks</Text>
        </View>
        <View>
          {myStocks.map((props) => (
            <TouchableOpacity
    ...
    <View style={{ flex: 0, flexDirection: "row", paddingLeft: 20 }}>
      ...
      <View style={{ paddingRight: 20 }}>
        ...
        <View
          style={{
            borderRadius: 20,
            backgroundColor: `${increase ? "green" : "red"}`,
            padding: 3,
          }}>
